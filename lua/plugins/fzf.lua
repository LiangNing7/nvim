return {
    ...
    keys = {
        ...
        -- FZF-Lua
        { "<C-e>",     "<cmd>FzfLua buffers<CR>",            desc = "FZF: Browse and switch open buffers" },
        { "<C-f>",     "<cmd>FzfLua lgrep_curbuf<CR>",       desc = "FZF: Search in current buffer" },
        { "<leader>fp", "<cmd>FzfLua live_grep<CR>",              desc = "FZF: Live grep across project files" },
        { "<leader>fo", "<cmd>FzfLua oldfiles<CR>",           desc = "FZF: Open recently used files list" },
        { "<leader>ts", "<cmd>FzfLua treesitter<CR>",        desc = "FZF: Search symbols using Treesitter" },
        { "<leader>sh", "<cmd>FzfLua search_history<CR>",    desc = "FZF: Search command-line history" },
        { "<leader>fm", "<cmd>FzfLua marks<CR>",              desc = "FZF: List all marks and jump to selection" },
        { "<leader>gp","<cmd>FzfLua git_commits<CR>",        desc = "FZF: Browse Git commits" },
        { "<leader>gb","<cmd>FzfLua git_bcommits<CR>",       desc = "FZF: Browse Git commits for current buffer" },
        { "<leader>gs","<cmd>FzfLua git_status<CR>",         desc = "FZF: Show Git status and staged changes" },
        { "<leader>fd", "<cmd>FzfLua lsp_document_diagnostics<CR>", desc = "List LSP diagnostics in document and jump to issue" },
    },
}
