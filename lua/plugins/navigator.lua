		...
		config = function()
			require("navigator").setup({
				...
				keymaps = {
					...
					{ key = "<Leader>ca", mode = "v", func = require("navigator.codeAction").range_code_action, desc = "range_code_action" },
					...
					{ key = "<Space>gm", func = require("navigator.formatting").range_format, mode = "n", desc = "range_format" },
